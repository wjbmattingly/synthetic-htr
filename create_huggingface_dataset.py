#!/usr/bin/env python3
"""
Convert Medieval Letters Synthetic Manuscripts to Hugging Face Dataset

This script processes the generated manuscript images and XML files to create
a Hugging Face dataset with the following structure:
- image: PIL Image of the manuscript page
- text: Original transcription (before abbreviations)
- abbreviated: Abbreviated form (what appears on the image)
"""
...
try:
    ...
    from datasets.features import Features, Value, Image as HFImage
except ImportError:
...
class ManuscriptDatasetConverter:
    ...
    def process_letter_directory(self, letter_dir: Path) -> List[Dict[str, Any]]:
        """
        Process a single letter directory and extract all pages.
        
        Args:
            letter_dir: Path to the letter directory
    ...
    def collect_all_data(self) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of all page data dictionaries
        """
        ...
        for i, letter_dir in enumerate(letter_dirs):
            ...
            try:
                pages_data = self.process_letter_directory(letter_dir)
    ...
    def create_dataset(self, data: List[Dict[str, Any]]) -> Dataset:
        ...
        # Convert PIL Images to the format expected by HF datasets
        formatted_data = []
        for item in data:
            # Convert PIL image to the format HF datasets expects
            formatted_item = {
                'image': item['image'],  # Keep as PIL Image - HF will handle conversion
                'text': item['text'],
    ...
    def save_dataset(self, dataset: Dataset):
        ...
        metadata = {
            ...
            'features': {
                ...
                'xml_path': 'Original path to the XML file'
            }
        }
    ...
    def convert(self):
        ...
        """
        print("🏰 Medieval Letters Dataset Converter")
        print("=" * 50)
