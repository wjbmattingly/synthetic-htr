#!/usr/bin/env python3
"""
Convert Medieval Letters Synthetic Manuscripts to Hugging Face Dataset (v2)

This script processes the generated manuscript images and XML files to create
a properly formatted Hugging Face dataset with the following structure:
...
class ManuscriptDatasetConverter:
        ...
        for i, letter_dir in enumerate(letter_dirs):
            ...
            try:
                ...
                for img_path in original_images:
                    ...
                    page_data = {
                        'image': str(img_path),  # Store path, not loaded image
    ...
    def convert(self):
        ...
        """
        print("🏰 Medieval Letters Dataset Converter v2")
        print("=" * 50)
